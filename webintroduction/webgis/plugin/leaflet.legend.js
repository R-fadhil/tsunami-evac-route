(function (factory, window) {
    ...
    L.Control.Legend = L.Control.extend({
        ...
        _buildContainer: function () {
            ...
            this._link.textContent = "LEGENDA";
            this._link.href = "#";
        ...
        _buildLegendItems: function (legendContainer, legend) {
            ...
            } else if (legend.type === "withoutsymbol") {//edited
            ...
            if(legend.type==="withoutsymbol"){//edited till the next coment
                symbolContainer.style.width = "0px";
